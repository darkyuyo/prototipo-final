...
public class PanelP1 : MonoBehaviour
{
    ...
    public void Actualizar_panel(){
        for(int cont=0; cont<nombre_habilidad.Count;cont++){
            if(cont<GameManager.instance.monstruo1Activo._abilities.Count){
                nombre_habilidad[cont].text=GameManager.instance.monstruo1Activo._abilities[cont]._ability.getName;
                descripcion_habilidad[cont].text=GameManager.instance.monstruo1Activo._abilities[cont]._ability.getDescription;
                valor_habilidad[cont].text=GameManager.instance.monstruo1Activo._abilities[cont]._ability.getValor.ToString();
                tipo_habilidad[cont].text=GameManager.instance.monstruo1Activo._abilities[cont]._ability.getTipo.ToString();
                tipo_poder_habilidad[cont].text=GameManager.instance.monstruo1Activo._abilities[cont]._ability.getPoder.ToString();
                if(GameManager.instance.ObtenerMultiplier()>=GameManager.instance.monstruo1Activo._abilities[cont]._ability.getValor){
